...
if (isset($_POST['cadastrarCliente'])):
    ...
    $nascimento = obrigatorio("nascimento", addslashes($_POST['nascimento']));
    ...
    criaSessao("nascimento", $nascimento);
                ...
                if (verificaCadastro("clientes", "cliente_login", $login)):
                    if (cadastrarCliente(array("nome" => $nome,"cidade"=>$cidade, "estado"=>$estado,"bairro"=>$bairro,
                                                "cep"=>$cep, "telefone"=>$telefone, "celular"=>$celular,
                                                 "endereco"=>$endereco,"login"=>$login, "senha"=>$senha, "nascimento"=>$nascimento))):
...
<div class="formularioCadastro">
    ...
    <div class="formCadastro">
        <form action="" method="POST">
            ...
            <label for="cep">Data Nascimento:</label>
            <input type="text" name="nascimento" value="<?php echo isset($_SESSION['nascimento']) ? $_SESSION['nascimento']: "";  ?>" class="txt_field_menor"></input> *

...
--
-- Host: 127.0.0.1
-- Generation Time: 01-Jun-2017 às 07:23
...
(4, 'Big Smoke', 'gordogta', '202cb962ac59075b964b07152d234b70');
...
(4, 'Shiryu de Dragão', 'Rozan', 'AC', 'Cinco Picos', '69921-000', '(83)93223-3030', '(83)99988-8899', '', 'Rua Leonel Pinto de Abreu 404', 'shiryu', '123', '1991-10-04');
...
(16, 11, 'Portuguesa tipo 6', '15.00', 'Portuguesa tipo 6', 'fotos/4fce7082bacc3.jpg', 'detalhes/4fce7082bacc3.jpg', '', NULL);
...
--
ALTER TABLE `dados_login_administrador`
  MODIFY `dados_login_administrador_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
...
--
ALTER TABLE `pedidos`
  MODIFY `pedidos_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `pizzas`
--
ALTER TABLE `pizzas`
  MODIFY `pizza_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
